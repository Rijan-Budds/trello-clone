  ...
  return (
    <footer className="w-full bg-slate-950/80 border-t border-slate-900/60 backdrop-blur-md">
      <div className="mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8 lg:py-16">
          ...
          <div className="space-y-6 xl:col-span-1">
            <Link href="/" className="flex items-center gap-2 group w-fit">
              <div className="flex h-8 w-8 items-center justify-center rounded-lg bg-gradient-to-br from-violet-600 to-indigo-600 text-white shadow-md shadow-indigo-500/20 group-hover:scale-105 transition-transform duration-200">
                <TrelloIcon className="h-4.5 w-4.5" />
              </div>
            ...
            <p className="text-sm text-slate-400 max-w-xs">
              Trello clone makes it easy for teams to manage projects, design workflows, and track task progress visually.
            </p>
        ...
        {/* Bottom */}
        <div className="mt-12 border-t border-slate-900/80 pt-8 flex flex-col md:flex-row md:items-center md:justify-between gap-4">
          <p className="text-xs text-slate-500">
            &copy; {currentYear} Trello Clone. Developed as a modern Kanban project management tool. All rights reserved.
          </p>
